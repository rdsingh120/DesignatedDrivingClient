...
import { colors, cardStyle, pageStyle, btn, modalOverlay, modalCard } from "../../styles/theme";
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
        ...
        {!trip && !tripLoading && tripError && (
          <div style={{ ...cardStyle, textAlign: "center", padding: "48px 20px" }}>
            ...
            <p style={{ margin: "0 0 8px", fontSize: 15, color: colors.dangerLight }}>
              Failed to load trip
            </p>
            ...
            <div style={{ ...cardStyle, marginBottom: 16 }}>
              ...
              <div style={{ background: colors.bgDeep, borderRadius: 10, overflow: "hidden" }}>
                ...
                >
                  ...
                  <span style={{ fontSize: 14, color: colors.textPrimary }}>
                    {trip.rider?.name || trip.rider?._id || "—"}
                  </span>
                </div>
                ...
                {(trip.status === "ASSIGNED" || trip.status === "ENROUTE") && (
                  ...
                  >
                    ...
                    {trip.driver_eta_minutes ? (
                      ...
                      <span style={{ fontSize: 13, color: colors.textMuted }}>Calculating...</span>
                    )}
                  </div>
                )}
                ...
                <div style={{ background: colors.bgDeep, borderRadius: 10, overflow: "hidden" }}>
                  {(trip.requestedAt || trip.createdAt) && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 14, color: colors.textPrimary }}>
                        {formatTime(trip.requestedAt || trip.createdAt)}
                      </span>
                    </div>
                  )}
                  ...
                  {trip.cancelledAt && (
                    <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 16px" }}>
                      ...
                      <span style={{ fontSize: 14, color: colors.dangerLight }}>
